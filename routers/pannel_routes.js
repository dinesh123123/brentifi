...
router.get("/category_update/:id",pannelControllers.categoryupdate);
...
router.get("/feedback/:id",pannelControllers.feedbackDelete);
router.get("/featuresList",pannelControllers.featureslist);
